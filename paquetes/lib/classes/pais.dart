...
//
//     final paisResponse = paisResponseFromMap(jsonString);

import 'dart:convert';

import 'package:paquetes/classes/regional_bloc.dart';
import 'package:paquetes/classes/traslations.dart';
...
class PaisResponse {
    ...
    factory PaisResponse.fromJson(String str) => PaisResponse.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory PaisResponse.fromMap(Map<String, dynamic> json) => PaisResponse(
        name: json['name'],
